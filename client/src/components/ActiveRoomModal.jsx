...
function ActiveRoomModal({ room, open, cancelButtonRef, setOpen }) {
  const navigate = useNavigate();
  const onCancel = async () => {
    const success = await leaveRoom();
    success ? setOpen(false) : console.log("unable to leave room");
  };
                    ...
                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                      ...
                      <div className="mt-2">
                        <p className="text-sm text-gray-500">
                          Looks like you were recently in a room with code:
                          {room && room.code} and it's still active. Do you want
                          to join?
                        </p>
                      </div>
                    </div>
...
export default ActiveRoomModal;
